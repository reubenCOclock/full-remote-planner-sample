...
class UserRHType extends AbstractType
{ 
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('role',EntityType::class,['class'=>Role::class,'query_builder'=>function(EntityRepository $er){
            return $er->createQueryBuilder('r')->where('r.roleTitle!=:role_admin')->setParameter('role_admin','ROLE_ADMIN')->andWhere('r.roleTitle!=:role_client')->setParameter('role_client','ROLE_CLIENT');;
        ...
        ->add('birthday',DateType::class,['label'=>'Date de naissance','years'=>range('1970',$actualYear),'widget'=>'single_text','label'=>'birthday','label_attr'=>['class'=>'font-weight-bold']]) 
            ->add('probation_period',DateType::class,['label'=>"Date de fin de période d'essai",'years'=>range('1970',$actualYear),'widget'=>'single_text','label'=>'periode essai','label_attr'=>['class'=>'font-weight-bold']])
            ->add('contractual_status',ChoiceType::class, [
                ...
                'label'=>'statut contractuel','label_attr'=>['class'=>'font-weight-bold']
            ]) 
